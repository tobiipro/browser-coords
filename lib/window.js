...
exports.default = exports.window2 = exports.toJSON = void 0;
...
let window2 = {
  ...
  borderSize: function () {
    ...
    let widthDiff = window2.width() - _client.default.x() - _client.default.width();
    ...
    return _lodashFirecloud.default.max([0, _lodashFirecloud.default.floor(widthDiff / 2)]);
  },
  toJSON: exports.toJSON
};
exports.window2 = window2;
var _default = exports.window2;
