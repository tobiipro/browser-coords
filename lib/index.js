...
Object.defineProperty(exports, "cfg", {
  enumerable: true,
  get: function () {
    return _cfg.default;
  }
...
exports.default = exports.init = exports._onTouchEvent = exports._onMouseEvent = exports._guestimateV = exports._guestimateH = exports._setClient = exports._touchEventNames = exports._mouseEventNames = exports._passive = void 0;
...
exports._passive = _passive;
let _mouseEventNames = ['click', 'dblclick', 'mousemove', 'wheel'];
exports._mouseEventNames = _mouseEventNames;
let _touchEventNames = ['touchstart']; // -----------------------------------------------------------------------------
...
let _setClient = function ({
  ...
  if (!_lodashFirecloud.default.isUndefined(x)) {
    _cfg.default.client.x = x;
    _cfg.default.window.viewport.x = x;
  }

  if (!_lodashFirecloud.default.isUndefined(y)) {
...
exports._guestimateH = _guestimateH;
...
let _guestimateV = function () {
  ...
  let heightDiff = _window.default.height() - _client.default.height() - _window.default.borderSize(); // assume border only on top i.e. no status bar (guessing this is most common)
...
exports._guestimateV = _guestimateV;

let _onMouseEvent = function (e) {
  if (!_lodashFirecloud.default.isUndefined(window.mozInnerScreenX)) {
  ...
  if (_lodashFirecloud.default.isUndefined(e.clientX) || _lodashFirecloud.default.isUndefined(e.clientY) || _lodashFirecloud.default.isUndefined(e.screenX) || _lodashFirecloud.default.isUndefined(e.screenY)) {
    return;
  } // bringing all to device pixels


  let x = _lodashFirecloud.default.round(e.screenX * _screen.default.osZoomFactor() - _window.default.x() - e.clientX * _screen.default.osZoomFactor() * _page.default.zoomFactor());

  let y = _lodashFirecloud.default.round(e.screenY * _screen.default.osZoomFactor() - _window.default.y() - e.clientY * _screen.default.osZoomFactor() * _page.default.zoomFactor());
