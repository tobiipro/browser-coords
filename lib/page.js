...
let _toJSON = exports._toJSON = function () {
  return (0, _util.roundRect)({
    ...
    zoomFactorPercentile: _lodash2.default.round(exports.page.zoomFactor() * 100)
  });
};
...
let page = exports.page = {
  ...
  width: (0, _util.maybeThrottle)(function () {
    return _lodash2.default.max([// same as jQuery(document).width
  ...
  height: (0, _util.maybeThrottle)(function () {
    return _lodash2.default.max([// same as jQuery(document).height
  ...
  url: (0, _util.maybeThrottle)(function () {
