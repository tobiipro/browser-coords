...
exports.default = exports.page = exports.toJSON = void 0;
...
let page = {
  ...
  width: (0, _util.throttle)(function () {
    ...
    document.body.scrollWidth, document.documentElement.scrollWidth, document.body.offsetWidth, document.documentElement.offsetWidth, document.documentElement.clientWidth]) * _screen.default.osZoomFactor();
  }),
  height: (0, _util.throttle)(function () {
    return _lodashFirecloud.default.max([// same as jQuery(document).height
    document.body.scrollHeight, document.documentElement.scrollHeight, document.body.offsetHeight, document.documentElement.offsetHeight, document.documentElement.clientHeight]) * _screen.default.osZoomFactor();
  }),
  zoomFactor: function () {
