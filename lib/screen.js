...
exports.default = exports.screen = exports.toJSON = void 0;
...
let screen = {
  ...
  osZoomFactor: (0, _util.throttle)(function () {
    ...
    let osZoomFactor = window.devicePixelRatio / (_cfg.default.page.zoomFactor * screen.pixelRatio());
