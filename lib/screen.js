...
let _toJSON = exports._toJSON = function () {
  return (0, _util.roundRect)({
    ...
    osZoomFactorPercentile: _lodashFirecloud2.default.round(exports.screen.osZoomFactor() * 100),
    pixelRatioPercentile: _lodashFirecloud2.default.round(exports.screen.pixelRatio() * 100)
  });
};
...
let screen = exports.screen = {
  ...
  osZoomFactor: (0, _util.throttle)(function () {
    if (!_lodashFirecloud2.default.isUndefined(_cfg2.default.screen.osZoomFactor)) {
    ...
    return _lodashFirecloud2.default.round(osZoomFactor, 2);
  }),

  pixelRatio: (0, _util.throttle)(function () {
    if (!_lodashFirecloud2.default.isUndefined(_cfg2.default.screen.pixelRatio)) {
      return _cfg2.default.screen.pixelRatio;
    }

    if (_lodashFirecloud2.default.includes(navigator.appVersion, 'Win')) {
    ...
    return _lodashFirecloud2.default.round(pixelRatio, 2);
  }),
